...
router.get('/:id', async (req, res) => {
    ...
    try {
        ...
        const postResult = await conn.execute(
            `SELECT p.id, p.title, u.userID AS author, p.content, TO_CHAR(p.created_at, 'YYYY-MM-DD') AS created_at,
        ...
        const commentResult = await conn.execute(
            `SELECT c.id, c.author_id, c.content, u.userID AS author, TO_CHAR(c.created_at, 'YYYY-MM-DD HH:MM') AS created_at, c.parent_comment_id 
